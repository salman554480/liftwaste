...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <span
                                                class="badge <?php echo $status_class; ?> fs-6"><?php echo $status_text; ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card my-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="newNoteField" rows="3"
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-4" id="adminActionsCard">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-warning w-100" onclick="assignToUser(<?php echo $email_id; ?>)"
                                    id="assignToUserBtn" disabled>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php if ($email['status'] === 'assigned'): ?>
                                <button class="btn btn-success w-100 mb-2"
                                    onclick="updateStatus(<?php echo $email_id; ?>, 'completed')">
            ...
            .then(data => {
                if (data.success) {
                    ...
                    return fetch('query/update_status.php', {
                        ...
                        body: 'email_id=' + emailId + '&status=' + newStatus + '&admin_email=' +
    ...
    function updateStatus(emailId, newStatus) {
        ...
        // Use the current admin's email from PHP session
        const adminEmail = '<?php echo $admin_email; ?>';
        ...
        fetch('query/update_status.php', {
                ...
                body: 'email_id=' + emailId + '&status=' + newStatus + '&admin_email=' + encodeURIComponent(
                    adminEmail)
            })
            .then(response => response.json())
            .then(data => {
    ...
    function loadUsers() {
        fetch('query/get_users.php')
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    loadUsersIntoSelect(data.users);
                } else {
                    document.getElementById('assignToUser').innerHTML =
                        '<option value="">Failed to load users</option>';
                }
            })
            .catch(error => {
                console.error('Error:', error);
                document.getElementById('assignToUser').innerHTML = '<option value="">Error loading users</option>';
            });
    }
